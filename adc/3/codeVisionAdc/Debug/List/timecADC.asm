...
_0x0:
	.DB  0x74,0x31,0x3D,0x25,0x64,0x20,0x74,0x32
	.DB  0x3D,0x20,0x25,0x64,0xA,0x20,0x73,0x3D
...
; 0000 00B0 // ADC Clock frequency: 500.000 kHz
...
; 0000 00D2          sprintf(lcd_show,"t1=%d t2= %d\n s=%d  ",temp1,temp2,second);
	MOVW R30,R28
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
